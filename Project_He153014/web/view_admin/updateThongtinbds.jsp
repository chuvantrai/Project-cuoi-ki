    ...
    <body>
        ...
        <div class="row" style="width: 101%; background-color: #c1c3c4;">
            <div class="col-md-7 shadow-none p-3 mb-5 bg-light rounded" style=" margin: 25px;">
                ...
                <form action="update" method="POST" onsubmit = "return checkForm4()">
                <div class="form-row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" name="img" value="${requestScope.thongtinbds.imgavar}">
                </div>
